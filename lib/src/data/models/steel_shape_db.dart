...
class SteelShapeDB {
  ...
  // 대표 규격.
  // (2026-09 조사: 미주철근철강·부현철강 앵글 규격표. 125x125x9는 표에 없지만 예전부터 목록에 있어 둔다.)
  static final List<SteelShapeItem> angles = [
    for (final v in [
      '25x25x3',
      '30x30x3',
      '40x40x3',
  ...
  // 각파이프(변x변xt, 직사각은 가로x세로xt). 시판 규격: 미주철근철강 각형강관(SPSR) 표. 표의 100x100x9는 중량이 맞지 않아 뺐다.
