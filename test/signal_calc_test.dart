...
void main() {
  ...
  group('루프 전압', () {
    test('24V, 250Ω, 전선 1.5sq 500m: 20mA 18.64V·21mA 18.37V, 최대 643Ω', () {
      ...
      final lc = loopCheck(supplyV: 24, minV: 10.5, ohms: [250, 0, wire]);
      expect(lc.totalOhm, closeTo(262.1, 1e-9));
      expect(lc.volts20, closeTo(24 - 0.02 * 262.1, 1e-9));
      expect(lc.volts21, closeTo(24 - 0.021 * 262.1, 1e-9));
      expect(lc.maxOhm21, closeTo(642.857, 1e-3));
      expect(lc.okAt21(10.5), isTrue);
    });
    test('24V, 650Ω: 20mA는 11V로 되지만 21mA는 10.35V < 10.5V', () {
      final lc = loopCheck(supplyV: 24, minV: 10.5, ohms: [650]);
      expect(lc.okAt21(10.5), isFalse);
