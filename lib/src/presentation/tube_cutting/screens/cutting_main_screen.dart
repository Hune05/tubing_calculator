...
class _CuttingMainScreenState extends State<CuttingMainScreen>
  ...
  Widget _buildLengthInputCard(int index) {
    ...
    // 카드(흰 배경+굵은 테두리)와는 다른 톤 - 옅은 회색 배경 + 왼쪽 색
    // 띠 - 로 카드화해서 "부속 사이를 잇는 길이"라는 흐름은 유지하면서
    // 담음새를 줬다.
    return Padding(
      padding: const EdgeInsets.symmetric(vertical: 6),
      child: Container(
        ...
        child: IntrinsicHeight(
          child: Row(
            ...
            children: [
              Container(
                width: 5,
                color: isInterference ? CuttingColors.danger : makitaTeal,
              ),
              Expanded(
                child: Padding(
