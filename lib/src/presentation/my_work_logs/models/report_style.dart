...
class ReportStyle {
  ...
  // 필드 헬퍼 3번: 사진에 날짜·현장 이름·위치를 찍는다(카메라로 찍은 사진만).
  bool photoStamp;
  ...
  static ReportStyle fromJson(Map<String, dynamic> j) => ReportStyle(
    ...
    photoStamp: j['photoStamp'] != false, // 없으면 켬(기본)
