...
void main() {
  test(
    'unfinished last-week schedule is carried over; older is late; summary first',
    () {
          ...
          'schedules': [
            {
              ...
              'title': '전주끝',
              'isCompleted': false,
              'dateTime': mon.subtract(const Duration(days: 4)),
              'endDate': mon.subtract(const Duration(days: 3)),
            },
            {
              'id': 's2',
              'title': '오래전',
              'isCompleted': false,
              'dateTime': mon.subtract(const Duration(days: 20)),
              'endDate': mon.subtract(const Duration(days: 19)),
            },
          ],
        },
      ];
